...
describe("PlayCountPill", () => {
	...
	it("renders null when count <= 1", async () => {
		...
		Spicetify.ReactDOM.render(
			Spicetify.React.createElement(PlayCountPill, { count: 1, variant: "pill", firstPlayedAt: null }),
			container,
		);
	...
	it("renders null when count is 0", async () => {
		const { PlayCountPill } = await import("../app/components/PlayCountPill");
		Spicetify.ReactDOM.render(
			Spicetify.React.createElement(PlayCountPill, { count: 0, variant: "pill", firstPlayedAt: null }),
			container,
		);
		expect(container.innerHTML).toBe("");
	});
	...
	describe("pill variant (default)", () => {
		it("renders with play-count-pill class and correct text", async () => {
			const { PlayCountPill } = await import("../app/components/PlayCountPill");
			Spicetify.ReactDOM.render(
				Spicetify.React.createElement(PlayCountPill, { count: 14, variant: "pill", firstPlayedAt: null }),
				container,
			);
		...
		it("renders dot indicator", async () => {
			const { PlayCountPill } = await import("../app/components/PlayCountPill");
			Spicetify.ReactDOM.render(
				Spicetify.React.createElement(PlayCountPill, { count: 5, variant: "pill", firstPlayedAt: null }),
				container,
			);
		...
		it("shows tooltip with play count and first-play date", async () => {
			...
			Spicetify.ReactDOM.render(
				Spicetify.React.createElement(PlayCountPill, { count: 14, variant: "pill", firstPlayedAt: firstPlayed }),
				container,
			);
			const pill = container.querySelector(".play-count-pill");
		...
		it("shows tooltip without date when firstPlayedAt is null", async () => {
			const { PlayCountPill } = await import("../app/components/PlayCountPill");
			Spicetify.ReactDOM.render(
				Spicetify.React.createElement(PlayCountPill, { count: 7, variant: "pill", firstPlayedAt: null }),
				container,
			);
			const pill = container.querySelector(".play-count-pill");
	...
	describe("bubble variant", () => {
		it("renders with play-count-bubble class", async () => {
			const { PlayCountPill } = await import("../app/components/PlayCountPill");
			Spicetify.ReactDOM.render(
				Spicetify.React.createElement(PlayCountPill, { count: 14, variant: "bubble", firstPlayedAt: null }),
				container,
			);
	...
	describe("minimal variant", () => {
		it("renders with play-count-minimal class", async () => {
			const { PlayCountPill } = await import("../app/components/PlayCountPill");
			Spicetify.ReactDOM.render(
				Spicetify.React.createElement(PlayCountPill, { count: 14, variant: "minimal", firstPlayedAt: null }),
				container,
			);
